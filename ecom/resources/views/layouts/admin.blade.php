        ...
        <aside class="sidebar">
            ...
            <nav class="mt-3">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item"><a class="nav-link {{ request()->routeIs('admin.orders.*') ? 'active' : '' }}" href="{{ route('admin.orders.index') }}"><i class="bi bi-receipt"></i> Orders</a></li>
                    ...
                    <li class="nav-item"><a class="nav-link {{ request()->routeIs('admin.ready-emails.*') ? 'active' : '' }}" href="{{ route('admin.ready-emails.index') }}"><i class="bi bi-envelope"></i> Ready Emails</a></li>
